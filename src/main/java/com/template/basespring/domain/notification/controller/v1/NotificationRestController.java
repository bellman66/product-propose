package com.template.basespring.domain.notification.controller.v1;
...
public class NotificationRestController extends RestApiController {
    ...
    public NotificationRestController(ObjectMapper objectMapper, NotificationService notificationService) {
        super(objectMapper);
